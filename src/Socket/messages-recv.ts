oldestMsg.keyimport { Boom } from "@hapi/boom";
...
export const makeMessagesRecvSocket = (config: SocketConfig) => {
	...
	const fetchMessageHistory = (jid: string, count: number, oldestMsg: proto.WebMessageInfo) => {
		if(!authState.creds.me?.id) {
			return new Error("not authenticated")
		}
		//historySync
		relayMessage(authState.creds.me?.id, {
				protocolMessage: {
